...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/r-quickjsr-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-quickjsr-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi global install r-quickjsr
```
...
It is possible to list all of the versions of `r-quickjsr` available on your platform:
...
```
pixi search r-quickjsr --channel conda-forge
```
